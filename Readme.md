...
<rect width="800" height="180" fill="#0d0d0d" rx="8"/>
  <!-- Sword blade path -->
<path d="M 80 140 Q 250 135, 400 90 Q 550 45, 720 30" fill="none" stroke="url(#bladeGrad)" stroke-width="3" stroke-linecap="round" filter="url(#glow)" opacity="0">
...
<animate attributeName="opacity" values="1;0.6;1" dur="2s" begin="2s" repeatCount="indefinite"/>
  ...
  <!-- Second slash (cross) -->
<path d="M 120 40 Q 280 80, 420 100 Q 580 125, 700 145" fill="none" stroke="#ff3333" stroke-width="2" stroke-linecap="round" filter="url(#glow)" opacity="0">
...
<svg width="300" height="80" viewBox="0 0 300 80" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Sword blade -->
<path d="M 30 60 Q 100 55, 150 40 Q 200 25, 270 20" fill="none" stroke="url(#closeGrad)" stroke-width="2" stroke-linecap="round" opacity="0.8">
